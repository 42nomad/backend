...
public class Define {
    ...
    public static final String TAKEN_ROOM = "(은)는 현재 다른 카뎃이 사용중 입니다.";
    public static final String LOST_AND_FOUND = ", 혹시 당신의 짐일수도..? 분실물 게시판을 확인해주세요.\n\"https://42nomad.kr/\"";
    // postId따서 바로 그 게시물로 날려주면 제일 좋긴 한데..
}
